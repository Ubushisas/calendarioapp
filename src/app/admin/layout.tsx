...
export default function AdminLayout({
  ...
  const navItems = [
    { href: '/admin', icon: IconLayoutDashboard, label: 'Panel' },
    { href: '/admin/appointments', icon: IconCalendarEvent, label: 'Citas' },
    { href: '/admin/messages', icon: IconMessageCircle, label: 'Mensajes' },
    { href: '/admin/patients', icon: IconUsers, label: 'Pacientes' },
    { href: '/admin/calendar', icon: IconCalendar, label: 'Calendario' },
    { href: '/admin/services', icon: IconBriefcase, label: 'Servicios' },
    { href: '/admin/assistant', icon: IconRobot, label: 'Asistente IA' },
